...
class LandVehicle(Vehicle):
    ...
    def __init__(self, id_vehicle: int = 1, model: str = "Model of vehicle",
        ...
        :type brand: str
        :param type: category the vehicle belongs to
        :type type: str
        ...
        :type fuel_type: str
        """
        super().__init__(id_vehicle, model, description, brand, type, weight, age, price, status)
...
if __name__ == '__main__':
    ...
    if LandVehicle1 == LandVehicle2:
        print(f'El vehiculo de id "{LandVehicle1.id_vehicle}" es igual al vehiculo de id "{LandVehicle2.id_vehicle}"')
    else:
        print(f'El vehiculo de id "{LandVehicle1.id_vehicle}" es diferente al vehiculo de id '
