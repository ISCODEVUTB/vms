...
class Vehicle(object):
    ...
    def type(self, type):
        ...
        :param type: what type of vehicle is
        :type type: str
        :return: none
        """
        self._type = type
...
if __name__ == '__main__':
    ...
    if vehicle1 == vehicle2:
        print(f'El vehiculo de id "{vehicle1.id_vehicle}" es igual al vehiculo de id "{vehicle2.id_vehicle}"')
    else:
        print(f'El vehiculo de id "{vehicle1.id_vehicle}" es diferente al vehiculo de id "{vehicle2.id_vehicle}"')
