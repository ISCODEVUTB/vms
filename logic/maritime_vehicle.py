...
class MaritimeVehicle(Vehicle):
    ...
    def __init__(self, id_vehicle: int = "Id of vehicle", model: str = "Model of vehicle",
        ...
        :type brand: str
        :param type: category the maritime vehicle belongs to
        :type type: str
...
if __name__ == '__main__':
    ...
    if MaritimeVehicle1 == MaritimeVehicle2:
        print(f'El vehiculo de id "{MaritimeVehicle1.id_vehicle}" es igual al vehiculo de id'
              f' "{MaritimeVehicle2.id_vehicle}"')
    else:
        print(f'El vehiculo de id "{MaritimeVehicle1.id_vehicle}" es diferente al vehiculo de id '
              f'"{MaritimeVehicle2.id_vehicle}"')
