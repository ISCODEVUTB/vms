...
class AirVehicle(Vehicle):
    ...
    def __init__(self, id_vehicle: int = 1, model: str = "Model of vehicle",
        ...
        :type brand: str
        :param type: kind of air vehicle it is
        :type type: str
...
if __name__ == '__main__':
    ...
    if AirVehicle1 == AirVehicle2:
        print(f'El vehiculo de id "{AirVehicle1.id_vehicle}" es igual al vehiculo de id "{AirVehicle2.id_vehicle}"')
    else:
        print(f'El vehiculo de id "{AirVehicle1.id_vehicle}" es diferente al vehiculo de id '
